# KRP-Discord-Bot
This is the official repository for the discord utilities bot for KRP. Please read through the terms of commissioning:
  1. All work must be given out atleast 1 week before the deadline.
  2. If I fail to complete the work within 2 weeks (without a proper notice or a valid reason), there applies a 50% discount on the price of that work.
  3. If I fail to complete the work within 4 weeks (without a proper notice or a valid reason), there applies a 100% discount on the price of that work.
